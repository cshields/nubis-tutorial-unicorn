...
In these examples the service name is called *nubis-cshieldsapp*. You will need to choose a unique service name for your deployment as their can only be one *nubis-cshieldsapp* deployment at a time in one account.
